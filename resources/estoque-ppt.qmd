...
::::: columns
::: {.column width="50%"}
![](lec.png){fig-align="center"}
:::

::: {.column width="50%"}
![](lec-custos.png){fig-align="center"}
:::
:::::
...
> [**Simulador LEC**](/lec.html)

```{=html}
<iframe src="lec.html" width="1600" height="450" style="border:1px solid black;"></iframe>
```
