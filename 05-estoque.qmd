...
## Custos Relevantes na Gestão de Estoques
...
> [**Simulador da Curva ABC**](/resources/curvaABC.html)

```{=html}
<iframe src="/resources/curvaABC.html" width="733" height="550" style="border:1px solid black;"></iframe>
```
...
> [**Simulador Decisões de Compra**](/resources/decisoes-compra.html)

```{=html}
<iframe src="/resources/decisoes-compra.html" width="733" height="550" style="border:1px solid black;"></iframe>
```

## O Modelo do Lote Econômico de Compra (LEC)
...
> [**Simulador LEC**](/resources/lec.html)

```{=html}
<iframe src="/resources/lec.html" width="733" height="550" style="border:1px solid black;"></iframe>
```
<br>
...
> [**Slides da Aula**](/resources/estoque-ppt.html)

```{=html}
<iframe src="/resources/estoque-ppt.html" width="733" height="550" style="border:1px solid black;"></iframe>
```
...
::: {style="display: flex; justify-content: center; margin-top: 20px; margin-bottom: 20px;"}
<audio controls src="resources/estoque-podcast.mp3" style="width: 400px;">
