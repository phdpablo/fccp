...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, leftrule=.75mm, breakable, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, rightrule=.15mm, toprule=.15mm, left=2mm, opacitybacktitle=0.6, toptitle=1mm]
