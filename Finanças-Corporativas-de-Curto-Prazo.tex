...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, rightrule=.15mm, titlerule=0mm, opacityback=0, arc=.35mm, breakable, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, left=2mm, bottomrule=.15mm]
