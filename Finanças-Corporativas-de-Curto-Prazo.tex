...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2466}}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, bottomtitle=1mm, colback=white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, breakable, arc=.35mm, left=2mm, coltitle=black]
