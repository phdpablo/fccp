...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, coltitle=black, toptitle=1mm, arc=.35mm, left=2mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, opacitybacktitle=0.6, opacityback=0]
...
\subsection{Resumo em áudio}\label{resumo-em-uxe1udio}
