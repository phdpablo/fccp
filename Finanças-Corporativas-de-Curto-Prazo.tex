...
\section*{\texorpdfstring{\emojitext{🧠}
Professor}{ Professor}}\label{sec-instrutor}
\addcontentsline{toc}{section}{\emojitext{🧠} Professor}

\markright{\emojitext{🧠} Professor}

A disciplina é ministrada e mantida nesse \emph{hub} por mim, Pablo
Rogers \emojitext{😉}, doutor em Administração pela Universidade de São
Paulo (FEA/USP) e professor de finanças e métodos quantitativos desde
2005 na UFU. Em meu \href{https://phdpablo.com/}{site pessoal} você
encontrará mais detalhes sobre minhas formações, competências,
trajetória e projetos.

\section*{\texorpdfstring{\emojitext{🎯}
Objetivos}{ Objetivos}}\label{sec-about}
\addcontentsline{toc}{section}{\emojitext{🎯} Objetivos}

\markright{\emojitext{🎯} Objetivos}
...
\section*{\texorpdfstring{\emojitext{📚}
Programa}{ Programa}}\label{sec-programa}
\addcontentsline{toc}{section}{\emojitext{📚} Programa}

\markright{\emojitext{📚} Programa}
...
\tightlist
\item
  \emojitext{🧭} \textbf{Elementos interativos do site} que facilitam a
  navegação e a compreensão dos conceitos.\\
\item
  \emojitext{🎧} \textbf{Resumos em áudio} gerados com auxílio de IA
  para promover inclusão e autonomia no estudo.\\
\item
  \emojitext{📄} \textbf{Apoio à redação de conteúdos}, buscando sempre
  preservar a autoria, com revisão e curadoria humana\footnote{Por
    exemplo, i) transcrever um vídeo do professor e redigir textualmente
    com estrutura lógica; ii) resumir os pontos importantes de um artigo
...
\section*{\texorpdfstring{\emojitext{📖}
Bibliografia}{ Bibliografia}}\label{sec-biblio}
\addcontentsline{toc}{section}{\emojitext{📖} Bibliografia}

\markright{\emojitext{📖} Bibliografia}
...
\section*{\texorpdfstring{\emojitext{🔍}
Citação}{ Citação}}\label{sec-cite}
\addcontentsline{toc}{section}{\emojitext{🔍} Citação}

\markright{\emojitext{🔍} Citação}

Se você utilizar qualquer conteúdo deste curso em seus trabalhos
acadêmicos, por favor, cite da seguinte forma:

\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, left=2mm]

Rogers, Pablo (2025). Finanças Corporativas de Curto Prazo (1.0).
Zenodo. \url{https://doi.org/10.5281/zenodo.17305482}. Disponível em:
\url{https://fccp.phdpablo.com}

\end{tcolorbox}

\section*{\texorpdfstring{\emojitext{🔓}
Licença}{ Licença}}\label{sec-lice}
\addcontentsline{toc}{section}{\emojitext{🔓} Licença}

\markright{\emojitext{🔓} Licença}
...
perder nenhum prazo, é importante \emojitext{🤢}. Diferente de
disciplinas essencialmente quantitativas, tais como Matemática
Financeira e Análise de Investimentos, que, geralmente, vem antes do
conteúdo de finanças de curto prazo (FCCP) nos currículos programáticos
das universidades brasileiras, essa disciplina depende muito de teorias
...
\chapter*{\texorpdfstring{\emojitext{📅}
Cronograma}{ Cronograma}}\label{sec-schedule}
\addcontentsline{toc}{chapter}{\emojitext{📅} Cronograma}

\markboth{\emojitext{📅} Cronograma}{\emojitext{📅} Cronograma}
...
diretamente os \textbf{slides} utilizados nas aulas \emojitext{🗣️},
aulas gravadas ou indicações de \textbf{vídeo} \emojitext{🎥} e
\textbf{leituras complementares} sobre os conteúdos \emojitext{📓}.
...
\bottomrule\noalign{}
\endlastfoot
\href{01-intro.html}{Introdução} & 1️⃣ &
\href{resources/01-intro-ppt.html}{\emojitext{🗣}}\href{https://www.youtube.com/live/OCt4f9IdO6U}{\emojitext{🎥}}\href{https://periodicos.fclar.unesp.br/iniciativa/article/view/19172}{\emojitext{📓}} \\
\href{02-giro.html}{Capital de Giro} & 3️⃣ &
\href{resources/02-giro-ppt.html}{\emojitext{🗣}}\href{https://youtu.be/p2tTUL2QILo?si=m4GFKwyvEaDLkMpJ}{\emojitext{🎥}}\href{https://journalppc.com/RPPC/article/view/1229}{\emojitext{📓}} \\
\href{03-caixa.html}{Administração de Caixa} & 7️⃣ &
\href{resources/03-caixa-ppt.html}{\emojitext{🗣}}\href{https://youtu.be/CjIFO_G76Po?si=mpfl8y-QNR5JB-TQ}{\emojitext{🎥}}\href{https://ojs.unifor.br/rca/article/view/394}{\emojitext{📓}} \\
\href{04-credito.html}{Gestão de Recebíveis} & 9️⃣ &
\href{resources/04-credito-ppt.html}{\emojitext{🗣}}\href{https://youtu.be/-K88ewqeV2U?si=0RFDrt-TtWLyvGSE}{\emojitext{🎥}}\href{https://www.researchgate.net/publication/273491445_Decisoes_de_Credito_em_Situacoes_de_Risco_Uma_Aplicacao_Pratica_do_Metodo_de_Monte_Carlo}{\emojitext{📓}} \\
\href{05-estoque.html}{Adminitração de Estoques} & 1️⃣2️⃣ &
\href{resources/05-estoque-ppt.html}{\emojitext{🗣}}\href{https://youtu.be/YaK1eUuLUXk?si=Z-794zw_Vu0pHaxW}{\emojitext{🎥}}\href{https://www.researchgate.net/publication/281934935_Avaliando_o_Risco_na_Gestao_Financeira_de_Estoques}{\emojitext{📓}} \\
\href{06-aval.html}{Estudo de Caso} & 5️⃣,1️⃣1️⃣,1️⃣5️⃣ &
\href{resources/02-giro-ppt.html}{\emojitext{🗣}}\href{https://youtu.be/hMK057spPIc?si=al3XqehfjyOZy7_F}{\emojitext{🎥}}\href{http://periodicos.unifacef.com.br/rea/article/view/2823}{\emojitext{📓}} \\
\end{longtable}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, titlerule=0mm, left=2mm, toprule=.15mm, coltitle=black, colback=white, toptitle=1mm, bottomtitle=1mm]
