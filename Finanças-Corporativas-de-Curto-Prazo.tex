...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1005}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8201}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Aula/Conteúdo
...
\href{./resources/intro-ppt.html}{🗣}🎥\href{https://medium.com/@fabiofigueiredo_44303/resenha-do-livro-desafio-aos-deuses-a-hist\%C3\%B3ria-do-risco-9607fab2aa30}{📓} \\
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, left=2mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, titlerule=0mm, arc=.35mm, opacityback=0, colback=white]
