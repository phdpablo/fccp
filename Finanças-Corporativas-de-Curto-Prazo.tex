...
\begin{tcolorbox}[enhanced jigsaw, colback=white, left=2mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, toprule=.15mm, coltitle=black, toptitle=1mm, titlerule=0mm, arc=.35mm, breakable, rightrule=.15mm, leftrule=.75mm]
