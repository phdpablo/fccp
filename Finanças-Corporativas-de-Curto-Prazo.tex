...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, toprule=.15mm, coltitle=black, arc=.35mm, left=2mm, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colback=white, opacityback=0, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, breakable]
