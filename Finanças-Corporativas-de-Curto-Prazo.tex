...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2714}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5143}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Aula/Conteúdo
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacityback=0, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, toptitle=1mm, bottomtitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, coltitle=black]
