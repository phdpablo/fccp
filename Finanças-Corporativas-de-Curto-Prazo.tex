...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, opacityback=0, toptitle=1mm, toprule=.15mm, colback=white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, leftrule=.75mm, bottomrule=.15mm, left=2mm, titlerule=0mm, rightrule=.15mm]
