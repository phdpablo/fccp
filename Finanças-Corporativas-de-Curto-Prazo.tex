...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, colback=white, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, breakable, toprule=.15mm, titlerule=0mm, opacityback=0, coltitle=black]
