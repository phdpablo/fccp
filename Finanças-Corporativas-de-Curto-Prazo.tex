...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, rightrule=.15mm, breakable, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, bottomtitle=1mm]
