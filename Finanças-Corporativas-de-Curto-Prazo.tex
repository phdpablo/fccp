...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2568}}
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4865}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Aula/Conteúdo
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, breakable, coltitle=black, opacitybacktitle=0.6, colback=white, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, left=2mm, opacityback=0]
