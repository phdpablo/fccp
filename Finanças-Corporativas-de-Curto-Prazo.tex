...
\chapter*{🧠 Professor}\label{sec-instrutor}
\addcontentsline{toc}{chapter}{🧠 Professor}

\markboth{🧠 Professor}{🧠 Professor}
...
\chapter*{🎯 Objetivos}\label{sec-about}
...
\chapter*{📚 Programa}\label{sec-programa}
\addcontentsline{toc}{chapter}{📚 Programa}

\markboth{📚 Programa}{📚 Programa}
...
\chapter*{⚙️ Metodologia}\label{sec-method}
\addcontentsline{toc}{chapter}{⚙️ Metodologia}

\markboth{⚙️ Metodologia}{⚙️ Metodologia}
...
\chapter*{📖 Bibliografia}\label{sec-biblio}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, breakable, toptitle=1mm, leftrule=.75mm, toprule=.15mm, titlerule=0mm, arc=.35mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, left=2mm, opacityback=0, coltitle=black]
