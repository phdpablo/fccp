...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, rightrule=.15mm, bottomtitle=1mm, opacityback=0, leftrule=.75mm, toprule=.15mm]
