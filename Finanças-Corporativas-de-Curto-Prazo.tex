...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacityback=0, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Linguagem da Matemática Financeira}, opacitybacktitle=0.6, left=2mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, arc=.35mm, colback=white]
